...
class Display(object):
    ...
    def __init__(self, spi, cs, dc, rst,
        ...
        Args:
            ...
            rotation (Optional int): Rotation must be 0, 90, 180 default or 270
        """
        self.spi = spi
        self.cs = cs
        self.dc = dc
...
while True:
    ...
    if not has_screen_drawned:
        display.draw_circle(cx, cy, r, COLORS_WHITE)
        display.draw_text8x8(timer_text_x, timer_text_y, "25:00", COLORS_WHITE, COLORS_BLACK)
    ...
    if has_timer_started and not has_timer_paused:
        while time.ticks_diff(time.ticks_ms(), last_tick) >= 1000:
            ...
            display.draw_line(x1, y1, x2, y2, COLORS_WHITE)
            display.fill_rectangle(timer_text_x - 30, timer_text_y - 10, 60, 20, COLORS_BLACK)
            display.draw_text8x8(timer_text_x, timer_text_y, timer_text, COLORS_WHITE, COLORS_BLACK)
